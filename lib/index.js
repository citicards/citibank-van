...
class CitibankVAN {
  constructor() {
    ...
    this.creditCards = [];
    this.MsgNo = 0;
    this.request = (requestObject) => this.api.post(CITIBANK.APPLET_SUB_URL, this.conformJSONtoRequest(requestObject));
  }
  ...
  getCookies() {
    return this.api.get(CITIBANK.COOKIES_SUB_URL);
  }
  getMsgNo() {
    this.MsgNo++;
    return this.MsgNo;
